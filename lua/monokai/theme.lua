...
local editor = {
	...
	StatusLine = { fg = colors.warmgrey, bg = colors.black, reverse = true },
...
local treesitter = {
	...
	TSKeywordOperation = { fg = colors.pink },
	...
	TSStrong = { fg = colors.pink },
	TSEmphasis = { fg = colors.pink },
	TSUnderline = { fg = colors.pink },
	TSStrike = { fg = colors.pink },
