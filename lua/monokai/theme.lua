...
local treesitter = {
	...
	{ "@constBuiltin", { fg = colors.darkpurple, bold = true, italic = true } },
	{ "@constMacro", { fg = colors.green } },
	...
	{ "@include", { fg = colors.pink, bold = true } },
	{ "@keyword", { fg = colors.pink, bold = true } },
	{ "@keywordFunction", { fg = colors.pink, bold = true } },
	{ "@keywordOperation", { fg = colors.pink, bold = true } },
	{ "@keywordReturn", { fg = colors.pink, bold = true } },
	{ "@label", { fg = colors.pink } },
	...
	{ "@parameterReference", { fg = colors.pink } },
	{ "@property", { fg = colors.green } },
	{ "@punctDelimiter", { fg = colors.white } },
	{ "@punctBracket", { fg = colors.white } },
	{ "@punctSpecial", { fg = colors.white } },
	...
	{ "@text", { fg = colors.pink } },
	{ "@strong", { bold = true } },
	{ "@emphasis", { fg = colors.pink, italic = true } },
	...
	{ "@uRL", { fg = colors.white } },
	{ "@math", { fg = colors.pink } },
	{ "@textReference", { fg = colors.pink } },
	{ "@environment", { fg = colors.pink } },
	{ "@environmentName", { fg = colors.pink } },
	{ "@note", { fg = colors.pink } },
	{ "@warning", { fg = colors.pink } },
	{ "@danger", { fg = colors.pink } },
	{ "@type", { fg = colors.pink } },
	{ "@typeBuiltin", { fg = colors.darkpurple, bold = true, italic = true } },
	{ "@variable", { fg = colors.orange } },
	{ "@variableBuiltin", { fg = colors.darkaqua, bold = true, italic = true } },
}
